          ...
          <div className="rounded-3xl border border-white/10 bg-ink/60 p-8 backdrop-blur-2xl">
            {submitted ? (
              ...
              >
                ...
                <h3 className="mt-6 font-heading text-2xl text-cream">
                  Table Reserved
                </h3>
              ...
              >
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label className="mb-1.5 block text-xs uppercase tracking-widest text-beige-muted">
                      Full Name
                    </label>
