            ...
            return (
              <Reveal key={feature.title} delay={i * 0.1}>
                <motion.div
                  ...
                  <h3 className="mt-6 font-heading text-lg font-semibold text-cream">{feature.title}</h3>
                  <p className="mt-2.5 text-sm leading-relaxed text-beige-muted">{feature.description}</p>
                </motion.div>
              </Reveal>);
